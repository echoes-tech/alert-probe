...
LDLIBSOPTIONS=-L/usr/local/lib -L../addon/dist/Debug/${CND_PLATFORM} -Wl,-rpath,/opt/echoes-alert/probe/lib `pkg-config --libs gobject-2.0 json-glib-1.0` -lpthread -lcunit -ldl -laddon  
