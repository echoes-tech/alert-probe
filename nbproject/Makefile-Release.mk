...
LDLIBSOPTIONS=-L/usr/local/lib -Laddon/dist/Release/${CND_PLATFORM} -Wl,-rpath,/opt/echoes-alert/probe/lib/addons -Wl,-rpath,/opt/echoes-alert/probe/lib -Wl,-rpath,lib/addons `pkg-config --libs gobject-2.0 json-glib-1.0` -lpthread -ldl -laddon  
