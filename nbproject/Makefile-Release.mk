...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/probe: ${TESTDIR}/tests/plugin.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c}   -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/probe $^ ${LDLIBSOPTIONS} 
...
${TESTDIR}/tests/addon.o: tests/addon.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/addon.o tests/addon.c


${TESTDIR}/tests/plugin.o: tests/plugin.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/plugin.o tests/plugin.c
...
${OBJECTDIR}/src/format_nomain.o: ${OBJECTDIR}/src/format.o src/format.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/format_nomain.o src/format.c;\
	else  \
...
${OBJECTDIR}/src/addon/addonList_nomain.o: ${OBJECTDIR}/src/addon/addonList.o src/addon/addonList.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/addon/addonList_nomain.o src/addon/addonList.c;\
	else  \
...
${OBJECTDIR}/src/log_nomain.o: ${OBJECTDIR}/src/log.o src/log.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/log_nomain.o src/log.c;\
	else  \
...
${OBJECTDIR}/src/plugin_nomain.o: ${OBJECTDIR}/src/plugin.o src/plugin.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin_nomain.o src/plugin.c;\
	else  \
...
${OBJECTDIR}/src/addon/addon_nomain.o: ${OBJECTDIR}/src/addon/addon.o src/addon/addon.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/addon/addon_nomain.o src/addon/addon.c;\
	else  \
...
${OBJECTDIR}/src/addon/addonLog_nomain.o: ${OBJECTDIR}/src/addon/addonLog.o src/addon/addonLog.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/addon/addonLog_nomain.o src/addon/addonLog.c;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/main_nomain.o main.c;\
	else  \
...
${OBJECTDIR}/src/sender_nomain.o: ${OBJECTDIR}/src/sender.o src/sender.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sender_nomain.o src/sender.c;\
	else  \
...
${OBJECTDIR}/src/addon/addonFile_nomain.o: ${OBJECTDIR}/src/addon/addonFile.o src/addon/addonFile.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/addon/addonFile_nomain.o src/addon/addonFile.c;\
	else  \
...
${OBJECTDIR}/src/conf_nomain.o: ${OBJECTDIR}/src/conf.o src/conf.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Wall -s -Iinclude `pkg-config --cflags libssl gobject-2.0 json-glib-1.0`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/conf_nomain.o src/conf.c;\
	else  \
